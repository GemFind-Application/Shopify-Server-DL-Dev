      ...
      <div className="range-slider_diamond">
        ...
        Price
          ...
          <div className="diamond-ui-slider diamond-small-slider">
            <Nouislider
              ...
              behaviour={"tap"}
              start={[
                props.tablemin ? props.tablemin : startValue,
                props.tablemax ? props.tablemax : lastValue,
              ]}
              step={1}
              range={{
        ...
        <div className="input-value-pr">
          <div className="input-value-left">
            <input
              type="text"
              value={props.tablemin ? props.tablemin : startValue}
          ...
          <div className="input-value-right">
            <input
              type="text"
              value={props.tablemax ? props.tablemax : lastValue}
