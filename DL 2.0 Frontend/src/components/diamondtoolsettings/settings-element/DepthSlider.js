      ...
      <div className="range-slider_diamond">
        ...
        Price
          ...
          <div className="diamond-ui-slider diamond-small-slider">
            <Nouislider
              ...
              behaviour={"tap"}
              start={[
                props.depthmin ? props.depthmin : startValue,
                props.depthmax ? props.depthmax : lastValue,
              ]}
              step={1}
              range={{
        ...
        <div className="input-value-pr dia-input-value">
          <div className="input-value-left">
            <input
              type="text"
              value={props.depthmin ? props.depthmin : startValue}
          ...
          <div className="input-value-right">
            <input
              type="text"
              value={props.depthmax ? props.depthmax : lastValue}
