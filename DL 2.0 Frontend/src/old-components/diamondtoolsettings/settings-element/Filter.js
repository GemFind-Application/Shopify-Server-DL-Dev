  ...
  useEffect(() => {
    if (loaded === false) {
      ...
      if (getminedsetting !== "" && getminedsetting !== null) {
        ...
        setTab("fancycolor");
      } else if (getcomparesetting !== "" && getcomparesetting !== null) {
        setTab("compare");
      }
    }
    // getNavigationData();
    ...
    <>
      ...
      <div className="gf-navigation_filter_left ">
        ...
        <ul className="n_filter_left">
          {getminedsetting !== "" && getminedsetting !== null && (
            <li className={`${getTab === "mined" ? "gf-active" : ""}`}>
      ...
      <div className="gf-save-reset-filter">
        <ul className="gf-navigation_right">
          <li>
            <a href="#!" onClick={onChange} className="gf-save-icon">
              <svg
                stroke="#fff"
                fill="#fff"
                stroke-width="0"
          ...
          <li>
            <a href="#!" onClick={handleresetpopup} className="gf-reset-icon">
              <svg
                stroke="#fff"
                fill="#fff"
                stroke-width="0"
