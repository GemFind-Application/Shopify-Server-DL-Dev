...
const PriceSlider = (props) => {
  ...
  useEffect(() => {
    ...
    if (
      ...
      getfancycookies._wpsavedfancydiamondfiltercookie.pricemindata
    ) {
    ...
    if (props.callbacktab === "mined") {
      ...
      if (
        ...
        getsettingcookies._wpsavediamondfiltercookie.pricemindata
      ) {
        setstartValue(Number(props.pricemindata));
        setlastValue(Number(props.pricemaxdata));
      }
    ...
    if (props.callbacktab === "labgrown") {
      ...
      if (
        ...
        getlabcookies._wpsavedlabgowndiamondfiltercookie.pricemindata
      ) {
        setstartValue(Number(props.pricemindata));
        setlastValue(Number(props.pricemaxdata));
      }
