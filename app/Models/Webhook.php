...
class Webhook extends Model
{
    public function setShopifyUninstall()
    {
        ...
        $email_id = $data['email'];
        $endpoint = 'https://api.hubapi.com/contacts/v1/contact/email/' . $email_id . '/profile?hapikey=' . env('HUBSPOT_KEY');
        $ch = curl_init();
        ...
        if ($status_code == 200) {
            ...
            $endpoint1 = 'https://api.hubapi.com/contacts/v1/contact/email/' . $email_id1 . '/profile?hapikey=' . env('HUBSPOT_KEY');
            ...
            $endpoint2 = 'https://api.hubapi.com/contacts/v1/contact?hapikey=' . env('HUBSPOT_KEY');
            $ch2 = curl_init();
