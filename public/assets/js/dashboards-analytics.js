...
(function () {
  ...
  // --------------------------------------------------------------------
  var totalRevenueChartEl,totalRevenueChartOptions;
  ...
  fetch("/api/graphdata", {
    ...
    .then((data) => {
      ...
      // console.log(data);
      myState.monthData = data.month;
      myState.countData = data.count;
      updateUI();
    })
    .catch((error) => {
      // Handle the error
