...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | This option allows you to override the package's built-in route names.x
    ...
    */
    ...
    'webhooks' => [
        ...
        //     'address' => env('SHOPIFY_WEBHOOK_1_ADDRESS', 'https://dl2.gemfind.us/webhook/app-uninstalled')
        // ],
        // [
        //     'topic' => env('SHOPIFY_WEBHOOK_2_TOPIC', 'shop/update'),
        //     'address' => env('SHOPIFY_WEBHOOK_2_ADDRESS', 'https://dl2.gemfind.us/webhook/shop-update'),
        // ],
    ],
    ...
    */
    ...
    'scripttags' => [
        // [
        //     'src' => env('SHOPIFY_SCRIPTTAG_1_SRC', 'https://dl2.gemfind.us/widgets/static/js/bundle.js'),
        //     'event' => env('SHOPIFY_SCRIPTTAG_1_EVENT', 'onload'),
        //     'display_scope' => env('SHOPIFY_SCRIPTTAG_1_DISPLAY_SCOPE', 'online_store')
        // ],
        // [
        //     'src' => env('SHOPIFY_SCRIPTTAG_2_SRC', 'https://dl2.gemfind.us/customCssFront/customFrontCss.js'),
