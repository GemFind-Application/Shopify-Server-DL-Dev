    ...
    return (
        <Card sectioned>
             <Banner title="Disclaimer" status="info">
                <p className="mb-2">
                Please check the tool online to make sure it works for your online jewelry store. Once you have installed and activated, there will be NO refunds, since the account has to be setup and training needs to be provided. Here is a <a target="_blank" href="https://gemfindapps.com/apps/diamondtools"> link </a> to our demo store, please check and make sure it meets your expectations. Contact us if you have any questions prior to activation at <a href="mailto:support@gemfind.com"> support@gemfind.com </a> or  call <a href="tel:+19497527710"> +19497527710 </a>
                </p>
               
            </Banner>
            <Banner title="DiamondLinkⓇ Powered By GemFind" status="info">
                <p className="mb-2">
                        ...
                        <div className="row text-center justify-content-center">
                            <div className="col-lg-6 mb-5 mb-lg-0">
                                <div className="bg-white p-5 rounded-lg shadow">
                                    ...
                                    DiamondLinkⓇ Powered By GemFind
                                    </h1>
