...
<body>
    ...
    &nbsp;&nbsp;&nbsp;
    <div class="personal-training-heading"
        style="background-color:#e8e8e8; color: #000; width: 100%; display: block; height: 100px; vertical-align: middle;">
    ...
    <div class="personal-training-heading"
        style="background-color:#1979c3; color: #fff; width: 100%; display: block;  height: 100px; vertical-align: middle;">
        <div style="width: 80%; float: left;">
        ...
        <div style="width: 10%; float: left; ">
            <p style="text-align: left; padding-top: 40px; padding-left: 50px;">
                <span><?php
                if(isset($diamond['diamondData']['showPrice']) && $diamond['diamondData']['showPrice'] == true ) { 
